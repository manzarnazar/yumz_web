...
import GuestOrderContainer from "containers/orderContainer/guestOrderContainer";
...
export default function OrderSingle({}: Props) {
  ...
  const { data, isLoading, refetch } = useQuery(
    ...
    () => orderService.guestTrack(orderId),
    {
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <GuestOrderContainer data={data?.data} loading={isLoading} />
      </div>
