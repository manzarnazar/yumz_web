...
import GuestCheckoutDeliveryForm from "./guestCheckoutDeliveryForm";
...
export default function GuestCheckoutDelivery({ data, formik, onPhoneVerify }: Props) {
  ...
  return (
    <div className={cls.card}>
      ...
      <Box display={delivery_type === "delivery" ? "block" : "none"}>
        <GuestCheckoutDeliveryForm data={data} formik={formik} onPhoneVerify={onPhoneVerify} />
      </Box>
