...
import GuestCheckoutProductItem from "components/checkoutProductItem/guestcheckoutProductItem";
...
export default function GuestCheckoutProducts({
  data,
  loading = false,
  formik,
}: Props) {
