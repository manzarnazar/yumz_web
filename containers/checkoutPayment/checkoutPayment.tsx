    ...
    <div className={cls.card}>
      ...
      <div className={cls.cardBody}>
        <div className={cls.block}>
          ...
          <div className={cls.row}>
          <div className={cls.labelWithTooltip}>
            {t("service.fee")}
            <span className={cls.tooltipWrapper} tabIndex={0}>
              <span className={cls.tooltipIcon}>?</span>
      ...
      {isDesktop ? (
        <ModalContainer open={openTip} onClose={handleCloseTip}>
          <TipWithoutPayment
            totalPrice={
              (Number(order.total_price) + (Number(shop?.bag_tax) === 1 ? 4 : 0)) || 0
            }
            currency={currency}
